...
function BasicInfoSection({ control, t }: BasicInfoSectionProps) {
  return (
...
function LocationSection({ control, t }: LocationSectionProps) {
  return (
    <Card className="bg-background">
      <CardHeader>
...
function FormActions({ tCommon, saveLabel, isSaving, onCancel }: FormActionsProps) {
  return (
